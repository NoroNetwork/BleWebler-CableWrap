...
document.addEventListener("DOMContentLoaded", () => {
  ...
  buttons.forEach(btn => {
    btn.addEventListener("click", () => {
      ...
      const cableDiv = document.getElementById("cableOptions");
      ...
      if (cableDiv) cableDiv.style.display = "none";
      ...
      if (type === "text") textDiv.style.display = "block";
        ...
        // Cable mode reuses the canvas (inside textOptions) plus its own panel.
        textDiv.style.display = "block";
        if (cableDiv) cableDiv.style.display = "block";
        if (typeof generateCableLabel === "function") generateCableLabel();
      }
    });
  });
